...
//import com.zhgame.common.utils.email.MailService;
 ...
 */
public class MyMappingJackson2HttpMessageConverter extends AbstractHttpMessageConverter<Object> {

	protected final Logger logger = LoggerFactory.getLogger(MyMappingJackson2HttpMessageConverter.class);
